...
def start(x,res):
    ...
    if re.search("jokes|joke|Jokes|Joke", res):
    ...
    elif re.search('google' and 'photos', res):
        photos = obj.show_google_photos()
        return(photos)

    elif re.search('local' and 'photos', res):
    ...
    elif re.search('recommend' and 'movies',res):
        ...
        integrate.ChatApplication._insert_message(x,res,"You")
        integrate.ChatApplication._insert_message(x,time,"Assistant")
        t2s(time)
        ...
        integrate.ChatApplication._insert_message(x,res,"You")
        integrate.ChatApplication._insert_message(x,open_result,"Assistant")
        ...
        integrate.ChatApplication._insert_message(x,res,"You")
        t2s('Hi')
        integrate.ChatApplication._insert_message(x,'Hi',"Assistant")
